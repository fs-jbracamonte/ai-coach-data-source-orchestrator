...
ALTER TABLE "daily_reports" ADD CONSTRAINT "daily_reports_team_id_teams_id_fk" FOREIGN KEY ("team_id") REFERENCES "public"."teams"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "meeting_transcripts" ADD CONSTRAINT "meeting_transcripts_team_id_teams_id_fk" FOREIGN KEY ("team_id") REFERENCES "public"."teams"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "jira_snapshots" ADD CONSTRAINT "jira_snapshots_team_id_teams_id_fk" FOREIGN KEY ("team_id") REFERENCES "public"."teams"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "slack_captures" ADD CONSTRAINT "slack_captures_team_id_teams_id_fk" FOREIGN KEY ("team_id") REFERENCES "public"."teams"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_daily_reports_team_id" ON "daily_reports" USING btree ("team_id");--> statement-breakpoint
CREATE INDEX "idx_daily_reports_team_date" ON "daily_reports" USING btree ("team_id","report_date");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_daily_team_author_date" ON "daily_reports" USING btree ("team_id","author_name","report_date");--> statement-breakpoint
CREATE INDEX "idx_transcripts_team_id" ON "meeting_transcripts" USING btree ("team_id");--> statement-breakpoint
CREATE INDEX "idx_transcripts_date" ON "meeting_transcripts" USING btree ("transcript_date");--> statement-breakpoint
CREATE INDEX "idx_transcripts_team_date" ON "meeting_transcripts" USING btree ("team_id","transcript_date");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_transcript_team_filename_date" ON "meeting_transcripts" USING btree ("team_id","filename","transcript_date");--> statement-breakpoint
CREATE INDEX "idx_jira_snapshots_team_id" ON "jira_snapshots" USING btree ("team_id");--> statement-breakpoint
CREATE INDEX "idx_jira_snapshots_team_week" ON "jira_snapshots" USING btree ("team_id","collected_week_start");--> statement-breakpoint
CREATE INDEX "idx_slack_captures_team_id" ON "slack_captures" USING btree ("team_id");--> statement-breakpoint
CREATE INDEX "idx_slack_captures_week_start" ON "slack_captures" USING btree ("collected_week_start");--> statement-breakpoint
CREATE INDEX "idx_slack_captures_team_week" ON "slack_captures" USING btree ("team_id","collected_week_start");--> statement-breakpoint
CREATE INDEX "idx_generated_reports_team_type_date" ON "generated_reports" USING btree ("team_id","report_type_id","generated_at");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_execution_id" ON "generated_reports" USING btree ("execution_id");--> statement-breakpoint
CREATE UNIQUE INDEX "uq_proj_type_hash" ON "generated_reports" USING btree ("team_id","report_type_id","content_hash");--> statement-breakpoint
